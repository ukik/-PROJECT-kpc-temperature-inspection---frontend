  ...
  <div class="q-pa-md">
    ...
    >
      ...
      <template v-slot:body="props">
        <q-tr :props="props">
          <q-td style="width: 67.5px !important;text-align: end;">
...
export default {
    ...
    pagination: {
      handler: function(after, before) {
        ...
        const object = (document.getElementsByClassName(
          "q-table__bottom row"
        )[0].children[0].innerText = `Halaman: ${vm.pagination.page}`);
  ...
  data() {
    return {
      ...
      visibleColumns: ["calories", "name", "protein", "sodium", "iron"],
      selected: [],
      filter: "",
      loading: false,
      pagination: {
      ...
      columns: [
        // { name: 'checkbox', label: 'checkbox', field: 'checkbox', sortable: true,
