    ...
    <q-page>
      <data-table :_store_module="store_module">
        ...
        <q-toolbar slot="title" style="padding:0px">
          ...
          <q-toolbar-title>Aset Lokasi</q-toolbar-title>
        </q-toolbar>
          ...
          <q-tr>
            ...
            <q-td key="name_location" :props="props.props">
              <q-chip v-pointer color="teal" text-color="white" icon="edit">
                {{ props.props.row.name_location ? props.props.row.name_location : data_row('name_location', props.props.row.__index) }}
                <q-tooltip
              ...
              <q-popup-edit
                ...
                @save="onUpdate('name_location', props.props.row.__index)"
              >
                <template v-slot="{ initialValue, value, emitValue, validate, set, cancel }">
                  <q-input
                    ...
                    @keypress.enter="onUpdate('name_location', props.props.row.__index)"
                    maxlength="50"
                    autofocus
                    counter
                    hint
...
export default {
  ...
  methods: {
    onUpdate(key, __index) {
      console.log(
        (this.$refs["spinner_name_location_" + __index]._data.visible = true)
      );
