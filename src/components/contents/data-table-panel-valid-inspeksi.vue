<template>
  ...
  <div>
    <q-table
      ...
      :hide-header="get_inspeksi_temperatur_panel_valid_grid"
    ...
    <!-- <q-card class="q-mt-sm">
      <q-card-section>
        <q-item>
          <q-item-section v-if="!isMobileViewport" avatar>
            <q-icon name="help_outline" class="text-green" style="font-size: 3rem;" />
          </q-item-section>
          ...
          <q-item-section>
            ...
            >Halaman ini berisi data tentang inspeksi conveyer yang bisa diisi oleh Temperature Man (TM) atau Admin. Data yang masuk wajib divalidasi oleh Admin agar bisa tampil di halaman laporan inspeksi. Dapat diakses oleh Admin, Pengawas, dan Temperature Man. Temperature Man tidak diizinkan mengakses data inspeksi karyawan lainnya.</q-item-label>
          </q-item-section>
        </q-item>
      </q-card-section>
    </q-card>-->
...
export default {
  ...
  methods: {
    ...
    buildURL() {
      ...
      return `/api/v1${q.segment}?year=${q.year}&month=${q.month}&sortBy=${q.sortBy}&direction=${q.descending}&per_page=${q.rowsPerPage}&page=${q.page}&search_column=${q.search_column}&search_operator=${q.search_operator}&search_query_1=${q.search_query_1}&search_query_2=${q.search_query_2}&validation=valid`;
    },
