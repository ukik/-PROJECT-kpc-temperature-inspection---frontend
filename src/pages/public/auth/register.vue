<template>
    <q-page style="position: absolute; z-index: 2; padding-bottom:75px;">
        <div class="q-pa-md">
            <info-validation v-if="rule_props != null" :_rule="rule_props" />

            <q-card class="my-card">
                <q-card-section style="padding-top: 12px;">
                    <q-toolbar style="padding:0px" :class="isMobileViewport ? 'text-center': ''">
                        <q-icon name="keyboard_arrow_left" size="lg" v-pointer @click="$router.back()">
                            <q-tooltip
                        ...
                        <q-toolbar-title>Pendaftaran Karyawan</q-toolbar-title>

                        <q-icon class="pull-right" v-if="!isMobileViewport" name="home" size="lg" v-pointer @click="$router.push({path:'login'})">
                            <q-tooltip
                              content-style="font-size: 14px"
                              anchor="center left"
                              self="center right"
                            >Halaman Login</q-tooltip>
                        </q-icon>                        
                ...
                <q-card-section>
                    ...
                    <q-form @submit="onSubmitHandler" @reset="onResetHandler">
                        ...
                        <div :class="!isMobileViewport ? 'row q-col-gutter-md' : 'row'">
                            ...
                            <div :class="!isMobileViewport ? 'row col-12 col-xs-2 col-sm-12 col-md-8 col-lg-8 col-xl-8 q-col-gutter-md' : 'row col-12 col-xs-2 col-sm-12 col-md-12 col-lg-8 col-xl-8'">
                                ...
                                <div :style="isMobileViewport ? 'margin-bottom:15px' : ''" class="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <q-select 
                                      ...
                                      map-options 
                                      option-value="value" 
                                      label="Posisi" :hint="isMobileViewport ? '' : 'Wajib: pilih posisi karyawan'" 
                                      lazy-rules 
                                      :rules="[
                                        val => val && val.length > 0 || 'Required *',
                                ...
                                <!-- Alamat -->
                                <div :style="isMobileViewport ? 'margin-bottom:15px' : ''" class="col-12">
                                    <q-input 
                            ...
                            <div :class="!isMobileViewport ? 'col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 q-col-gutter-md' : 'col-12 col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4'" >
                                  ...
                                  <q-field 
                                            ...
                                            <template v-slot:list="scope">
                                                <q-list separator>
                                                    ...
                                                    <q-item v-for="file in scope.files" :key="file.name">
                                                        ...
                                                        <q-item-section>
                                                            <q-item-label class="image-filename">
                                                                {{ file.name }}
                                                            </q-item-label>
                                    ...
                                    <div
                                      v-if="picked || form.photo_employee.length > 0"
                                    >
                                      <div class="q-pb-md text-center text-bold text-black-4">Photo Terakhir</div>
...
<q-btn :disable="loading" v-if="isMobileViewport" round icon="keyboard_arrow_left" color="primary" outline="" class="q-ml-sm" @click="$router.back()"/>
                        ...
                        <!-- <div 
                          ...
                          :style="isMobileViewport ? 'display: flex; justify-content: center; margin-top: 0px; padding-top: 10px; ' : ''" 
                          :class="!isMobileViewport ? 'q-pt-lg q-pb-mb' : ''">
<q-btn :disable="loading" label="Reset" type="reset" color="primary" outline="" :class="isMobileViewport ? '' : 'q-ml-sm'" />
<q-btn :disable="loading" label="Login" color="primary" outline="" class="q-ml-sm" @click="$router.push({path:'login'})"/>
                        </div>                         -->
...
export default {
  ...
  computed: {
    password_confirmation(){
      return  this["get_register_karyawan_password_confirmation"];
    },
    form(){
      return  this["get_register_karyawan_form"];
    },
    position_employee: {
      get(){
  ...
  methods: {
    ...
    requestAxios: _.debounce(function() {
      ...
      vm.$axios['post'](vm.buildURL, vm.form)
