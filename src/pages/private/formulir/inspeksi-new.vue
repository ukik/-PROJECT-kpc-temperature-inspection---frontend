...
export default {
  ...
  methods: {
    ...
    requestAxios: _.debounce(function() {
      ...
      vm.$axios.post(vm.buildURL+`?year=${vm.form.year}&month=${vm.form.month}`, vm.form)
        .then(function(response) {
          ...
          if (response.data.payload) {
            ...
            new Promise(resolve => {
              ...
              // ditambahkan ke store 
              // pada dasarnya data inspeksi masih invalid (belum divalidasi oleh admin)
