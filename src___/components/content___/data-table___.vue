  ...
  <div class="q-pa-md">
    ...
    >
      <template v-slot:top="props">
        ...
        <q-input dense debounce="250" v-model="filter" placeholder="Search">
      ...
      <template v-slot:body="props">
        <q-tr :props="props">
          ...
          <q-td
            key="name"
            class="ellipsis"
            style="background:rgba(0, 188, 255, 0.025); border-left:1px solid rgba(0, 0, 0, 0.12);border-right:1px solid rgba(0, 0, 0, 0.12);"
            :props="props"
          >
            {{ props.row.name }}
