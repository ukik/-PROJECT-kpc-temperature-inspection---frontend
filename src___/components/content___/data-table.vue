            ...
            <div class="row" style="display: flex;justify-content: flex-end;">
              ...
              >
                <q-btn
                  ...
                  @click="fetchData"
                />
                <q-btn color="secondary" @click="toolbar = !toolbar" class="glossy">
...
export default {
  ...
  computed: {
    ...
    displayColumns() {
      return this["get_" + this.store_module + "_displayColumns"];
    },
    separator() {
  ...
  methods: {
    ...
    buildURL() {
      ...
      q.descending = q.descending ? "desc" : "asc";
      q.search_operator =
      ...
      let local_paginate = {
        ...q,
        sortBy: route.column ? route.column : q.sortBy,
      ...
      return `${url}/api/v1${q.segment}?column=${q.sortBy}&direction=${q.descending}&per_page=${q.rowsPerPage}&page=${q.page}&search_column=${q.sortBy}&search_operator=${q.search_operator}&search_query_1=${q.search_query_1}&search_query_2=${q.search_query_2}`;
    },
    onRequest(props) {
      const vm = this;
